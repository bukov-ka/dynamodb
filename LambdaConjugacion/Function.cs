...
APIGatewayProxyRequest request, ILambdaContext context)
        {
            ...
            foreach(var q in request.QueryStringParameters)
            {
                Console.WriteLine("Query param {0}={1}", q.Key, q.Value);
            }
            Console.WriteLine("Filter params: {0}", filter);
